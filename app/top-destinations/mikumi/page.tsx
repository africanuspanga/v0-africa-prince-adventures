          ...
          <div className="max-w-4xl mx-auto">
            <div className="prose prose-lg max-w-none">
              <p className="text-xl leading-relaxed mb-8 text-muted-foreground">
                Mikumi National Park, often referred to as a mini-Serengeti due to its open plains and abundant
                wildlife, is one of Tanzania's most accessible and rewarding safari destinations. Its proximity to Dar
                es Salaam makes it a perfect choice for those with limited time, offering a genuine taste of the African
                wilderness without an extensive travel commitment.
              </p>
              ...
              <p className="leading-relaxed mb-6">
                ...
                population of "tree-climbing lions," a behavior more commonly associated with Lake Manyara National
                Park. Spotting a lion lounging on the branch of an acacia tree is a rare and thrilling sight.
              </p>
              ...
              <p className="leading-relaxed mb-6">
                The park's hippo pools, located a short distance from the main gate, are a major highlight. Here,
                hundreds of hippos gather, their grunts and splashes creating a lively spectacle. The pools are also a
                haven for a variety of waterbirds, making them a fantastic spot for birdwatching. Mikumi is a bird
                lover's paradise, with over 400 species recorded, including the colorful lilac-breasted roller,
                yellow-throated longclaw, and a variety of storks and raptors.
              </p>
              ...
              <p className="leading-relaxed mb-6">
                ...
                drive, you'll be able to spot animals grazing just off the road, a fascinating blend of modern travel
