      ...
      <section className="py-16 px-4">
        <div className="max-w-4xl mx-auto">
          <div className="prose prose-lg max-w-none">
            ...
            <p className="leading-relaxed mb-6">
              The park is legendary for its elephant population. It is home to some of the largest herds in Africa, with
              groups of up to 300 individuals congregating along the riverbanks. Watching these gentle giants interact,
              from matriarchs leading their families to playful youngsters wrestling in the mud, is a deeply moving
              experience. The elephants of Tarangire are often seen using their immense strength to dig in the dry
              riverbeds, seeking out subterranean water—a testament to their intelligence and resilience.
            </p>
            ...
            <p className="leading-relaxed mb-6">
              For birdwatchers, Tarangire is a paradise, home to species like the striking yellow-collared lovebird, the
              heavy-set Kori bustard, and the vibrant lilac-breasted roller. With over 550 bird species recorded, the
              park offers some of the best birding opportunities in Tanzania.
            </p>
